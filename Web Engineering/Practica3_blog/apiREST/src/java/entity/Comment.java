...
@NamedQueries({
    ...
    @NamedQuery(name = "Comment.findByPostId", query = "SELECT c FROM Comment c WHERE c.postIdpost.idpost = :postId ORDER BY c.date DESC"),
    @NamedQuery(name = "Comment.countByPostId", query = "SELECT COUNT(c) FROM Comment c WHERE c.postIdpost.idpost = :postId")})
